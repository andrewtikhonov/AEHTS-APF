 ...
 */
public class ExpStepDataDB implements Serializable {

    private static final Logger log = LoggerFactory.getLogger(ExpStepDataDB.class);
    ...
    public ExpStepDataDB(HashMap<String, Object> options) {
        map = options;
    }
