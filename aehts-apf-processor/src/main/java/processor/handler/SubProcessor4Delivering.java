 ...
 */
public class SubProcessor4Delivering {

    private final static Logger log = LoggerFactory.getLogger(SubProcessor4Delivering.class);

    public void processDeliveringSubmissions() throws Exception {

        log.info("Processing Delivering Submissions");
        ...
        //
        dal.chnageStatusForManySubms(DataConst.DELIVERING,
                DataConst.COMPUTED, "Computed, re-delivery");
    }
